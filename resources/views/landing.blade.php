...
<div class="page-wrapper">
            ...
            <div class="container hero-container">
                <div class="hero-glass-card">
                    ...
                    <div class="hero-buttons">
                        <a href="#profil" class="btn btn-primary">Pelajari Selengkapnya</a>
                        <a href="#komitmen" class="btn btn-secondary">Konsep K3</a>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section id="profil" class="page-section profile-page">
            <div class="container">
                <div class="page-heading center-heading">
                    ...
                    <p>
                        PT Mayora Indah Tbk merupakan perusahaan manufaktur makanan dan minuman dengan proses
                        produksi berskala besar. Karakter industri ini menjadikan K3 sebagai bagian penting
                        dalam menjaga keselamatan pekerja, mutu produksi, dan keberlanjutan operasional.
                    </p>
                </div>
                ...
                <div class="profile-layout">
                    <div class="profile-highlight">
                        ...
                        <p>
                            With various consumer goods, Mayora operates extensive manufacturing, storage, 
                            and utility processes requiring complete safety control.
                        </p>
                    </div>
            ...
            <div class="container">
                <div class="split-layout">
                    <div class="split-copy">
                        ...
                        <p>
                            Keselamatan dan Kesehatan Kerja adalah upaya untuk melindungi tenaga kerja,
                            orang lain di tempat kerja, aset perusahaan, proses produksi, serta lingkungan
                            agar kegiatan berjalan aman, efisien, dan produktif.
                        </p>

                        <div class="quote-box">
                            <strong>Zero Accident Mindset</strong>
                            <span>
                                Setiap bahaya harus dikenali, setiap risiko harus dikendalikan,
                                dan setiap pekerja berhak pulang dengan selamat.
                            </span>
                        </div>
                    </div>
        ...
        <section id="hukum" class="page-section law-page">
            <div class="container">
                <div class="page-heading">
                    ...
                    <p>
                        Penerapan K3 pada industri manufaktur mengacu pada peraturan keselamatan kerja,
                        ketenagakerjaan, APD, P2K3, APAR, BPJS Ketenagakerjaan, serta Sistem Manajemen K3.
                    </p>
                </div>
        ...
        <section id="risiko" class="page-section risk-page">
            <div class="container">
                <div class="page-heading center-heading light-heading">
                    ...
                    <p>
                        Setiap area memiliki karakter bahaya berbeda. Identifikasi bahaya membantu menentukan
                        pencegahan, pengendalian risiko, serta APD yang sesuai.
                    </p>
                </div>
        ...
        <section id="pengendalian" class="page-section control-page">
            <div class="container">
                <div class="page-heading center-heading">
                    ...
                    <p>
                        Risiko dikendalikan dari cara paling efektif, yaitu menghilangkan bahaya,
                        sampai perlindungan terakhir berupa penggunaan APD.
                    </p>
                </div>
            ...
            <div class="container">
                <div class="split-layout reverse-layout">
                    <div class="split-copy">
                        ...
                        <p>
                            APD tidak menghilangkan bahaya, tetapi mengurangi tingkat keparahan dampak
                            ketika pekerja terpapar risiko. Karena itu, pemilihan APD harus sesuai
    ...
    <footer class="site-footer">
        <div class="container footer-grid">
            <div class="footer-brand">
                <div class="footer-logo">
                    ...
                    <div>
                        <h3>K3 Mayora</h3>
                        <p>Landing Page Edukasi Keselamatan dan Kesehatan Kerja</p>
                    </div>
                </div>

                <p class="footer-description">
                    Website ini membahas penerapan K3 pada lingkungan perusahaan manufaktur FMCG,
                    mulai dari identifikasi bahaya, pengendalian risiko, APD, ergonomi, tanggap darurat,
                    struktur organisasi K3, dokumentasi, hingga Sistem Manajemen K3.
                </p>
            </div>
            ...
            <div class="footer-links">
                ...
                <a href="#komitmen">Konsep K3</a>
                <a href="#risiko">Identifikasi Bahaya</a>
        ...
        <div class="container footer-disclaimer">
            ...
            Website ini dibuat untuk keperluan tugas mata kuliah K3. Isi website bersifat edukatif
            dan simulatif berdasarkan materi perkuliahan serta karakter umum industri manufaktur makanan
            dan minuman, bukan website resmi PT Mayora Indah Tbk.
        </div>

        <div class="footer-bottom">
            <div class="container footer-bottom-content">
                <p>© Kelompok 4</p>
                <p>Profil Edukasi K3 PT Mayora Indah Tbk</p>
            </div>
        </div>
    </footer>
